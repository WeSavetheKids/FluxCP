    ...
    <footer>
        <div class="footer-main">
            <div class="row">
				...
				<div><img src="<?php echo $this->themePath('images/roslayers-logo-footer.png') ?>"/></div>

				<div class="col-three md-1-3 tab-1-2 mob-full footer-contact">
					<img src="<?php echo $this->themePath('images/roslayers-paladin.png') ?>"/>                  
                </div> <!-- end footer-contact -->

                <div class="col-three md-1-3 tab-full footer-info">            

                    <!-- <div class="footer-logo"></div> -->
					<img src="<?php echo $this->themePath('images/roslayers-logo-footer.png') ?>"/>
                    <p>
						Play Ragnarok Online for a cause and help sick kids today!
                    </p>
                    ...
                    <ul class="list-links">
                        ...
                        <li><a href="https://roslayers.com/forums/">Forums</a></li>
				...
				<div class="col-three md-1-3 tab-1-2 mob-full footer-contact">
					<img src="<?php echo $this->themePath('images/roslayers-champion.png') ?>"/>                  
                </div> <!-- end footer-contact -->
			...
			<div class="row">
				<div class="col-twelve">
					<div class="copyright">
						...
						<span>Powered by <a href="https://wesavethekids.org">We Save the Kids</a></span>	         	
						<span>A Program of <a href="https://visibleminoritynetwork.com" target="_blank">VMRTN</a></span><br>	
						<p class="text-muted">
